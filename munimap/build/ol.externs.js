...
/**
 * @param {ol.geom.Point|ol.render.Feature} pointGeometry
 */
ol.render.canvas.Immediate.prototype.drawPointGeometry = function(pointGeometry) {};


/**
 * @param {ol.geom.MultiPoint|ol.render.Feature} multiPointGeometry
 */
ol.render.canvas.Immediate.prototype.drawMultiPointGeometry = function(multiPointGeometry) {};


/**
 * @param {ol.geom.LineString|ol.render.Feature} lineStringGeometry
 */
 ...
 * @param {ol.TileUrlFunctionType} tileUrlFunction
 */
ol.source.VectorTile.prototype.setTileUrlFunction = function(tileUrlFunction) {};
...
/**
 * @typedef {{className: (string|undefined), condition: (ol.events.ConditionType|undefined), duration: (number|undefined)}}
 */
...
/**
 * @typedef {{features: (ol.Collection.<ol.Feature>|undefined), pixelTolerance: (number|undefined), source: (ol.source.Vector|undefined)}}
 */
...
/**
 * @typedef {{renderBuffer: (number|undefined), renderOrder: (Function), map: (ol.Map|undefined), extent: (ol.Extent|undefined), minResolution: (number|undefined), maxResolution: (number|undefined), opacity: (number|undefined), source: (ol.source.VectorTile|undefined), style: (ol.style.Style|Array.<ol.style.Style>|ol.style.StyleFunction|undefined), updateWhileAnimating: (boolean|undefined), updateWhileInteracting: (boolean|undefined), visible: (boolean|undefined)}}
 */
...
/**
 * @typedef {{culture: (string|undefined), key: (string), imagerySet: (string), maxZoom: (number|undefined), reprojectionErrorThreshold: (number|undefined), tileLoadFunction: (ol.TileLoadFunctionType|undefined), wrapX: (boolean|undefined)}}
 */
...
/**
 * @typedef {{attributions: (Array.<ol.Attribution>|undefined), format: (ol.format.Feature|undefined), logo: (string|olx.LogoOptions|undefined), opaque: (boolean|undefined), projection: (ol.proj.ProjectionLike), state: (ol.source.State|undefined), tileClass: (Function|undefined), tileGrid: (ol.tilegrid.TileGrid|undefined), tileLoadFunction: (ol.TileLoadFunctionType|undefined), tilePixelRatio: (number|undefined), tileUrlFunction: (ol.TileUrlFunctionType|undefined), url: (string|undefined), urls: (Array.<string>|undefined), wrapX: (boolean|undefined)}}
 */
...
/**
 * @typedef {{layer: (string), reprojectionErrorThreshold: (number|undefined), tileLoadFunction: (ol.TileLoadFunctionType|undefined), url: (string|undefined)}}
 */
...
/**
 * @typedef {{attributions: (Array.<ol.Attribution>|undefined), crossOrigin: (null|string|undefined), maxZoom: (number|undefined), opaque: (boolean|undefined), reprojectionErrorThreshold: (number|undefined), tileLoadFunction: (ol.TileLoadFunctionType|undefined), url: (string|undefined), wrapX: (boolean|undefined)}}
 */
olx.source.OSMOptions;


/**
 * @typedef {{attributions: (Array.<ol.Attribution>|undefined), canvasFunction: (ol.CanvasFunctionType), logo: (string|olx.LogoOptions|undefined), projection: (ol.proj.ProjectionLike), ratio: (number|undefined), resolutions: (Array.<number>|undefined), state: (ol.source.State|undefined)}}
 */
...
/**
 * @typedef {{layer: (string), minZoom: (number|undefined), maxZoom: (number|undefined), opaque: (boolean|undefined), reprojectionErrorThreshold: (number|undefined), tileLoadFunction: (ol.TileLoadFunctionType|undefined), url: (string|undefined)}}
 */
olx.source.StamenOptions;


/**
 * @typedef {{attributions: (Array.<ol.Attribution>|undefined), crossOrigin: (null|string|undefined), imageExtent: (ol.Extent), imageLoadFunction: (ol.ImageLoadFunctionType|undefined), logo: (string|olx.LogoOptions|undefined), projection: (ol.proj.ProjectionLike), imageSize: (ol.Size|undefined), url: (string)}}
 */
...
/**
 * @typedef {{attributions: (Array.<ol.Attribution>|undefined), crossOrigin: (null|string|undefined), jsonp: (boolean|undefined), reprojectionErrorThreshold: (number|undefined), tileLoadFunction: (ol.TileLoadFunctionType|undefined), url: (string), wrapX: (boolean|undefined)}}
 */
...
/**
 * @typedef {{attributions: (Array.<ol.Attribution>|undefined), crossOrigin: (string|null|undefined), logo: (string|olx.LogoOptions|undefined), tileGrid: (ol.tilegrid.WMTS), projection: (ol.proj.ProjectionLike), reprojectionErrorThreshold: (number|undefined), requestEncoding: (ol.source.WMTSRequestEncoding|string|undefined), layer: (string), style: (string), tileClass: (Function|undefined), tilePixelRatio: (number|undefined), version: (string|undefined), format: (string|undefined), matrixSet: (string), dimensions: (Object|undefined), url: (string|undefined), maxZoom: (number|undefined), tileLoadFunction: (ol.TileLoadFunctionType|undefined), urls: (Array.<string>|undefined), wrapX: (boolean|undefined)}}
 */
...
/**
 * @typedef {{attributions: (Array.<ol.Attribution>|undefined), crossOrigin: (null|string|undefined), logo: (string|olx.LogoOptions|undefined), reprojectionErrorThreshold: (number|undefined), url: (string), tierSizeCalculation: (string|undefined), size: (ol.Size)}}
 */
...
/**
 * @typedef {{geometry: (undefined|string|ol.geom.Geometry|ol.style.GeometryFunction), fill: (ol.style.Fill|undefined), image: (ol.style.Image|undefined), stroke: (ol.style.Stroke|undefined), text: (ol.style.Text|undefined), zIndex: (number|undefined)}}
 */
