...
/**
 * @typedef {{attributions: (ol.AttributionLike|undefined), distance: (number|undefined), extent: (ol.Extent|undefined), geometryFunction: (undefined|Function), format: (ol.format.Feature|undefined), logo: (string|undefined), projection: (ol.ProjectionLike), source: (ol.source.Vector), wrapX: (boolean|undefined)}}
 */
